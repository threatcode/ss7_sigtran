...
static asn_TYPE_tag2member_t asn_MAP_TCMessage_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (1 << 2)), 0, 0, 0 }, /* unidirectional at 28 */
    { (ASN_TAG_CLASS_APPLICATION | (2 << 2)), 1, 0, 0 }, /* begin at 29 */
    { (ASN_TAG_CLASS_APPLICATION | (4 << 2)), 2, 0, 0 }, /* end at 30 */
    { (ASN_TAG_CLASS_APPLICATION | (5 << 2)), 3, 0, 0 }, /* continue at 31 */
    { (ASN_TAG_CLASS_APPLICATION | (7 << 2)), 4, 0, 0 } /* abort at 33 */
};
