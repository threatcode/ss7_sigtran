...
static asn_TYPE_tag2member_t asn_MAP_resultretres_tag2el_3[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 }, /* localValue at 167 */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 0, 0, 0 } /* globalValue at 168 */
};
...
static asn_TYPE_tag2member_t asn_MAP_ReturnResult_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 } /* resultretres at 137 */
};
